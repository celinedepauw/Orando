...
const MobileNav = ({ isLogged, handleLogout }) => (
  <nav className="mobilenav">
    ...
    <a href="http://orando.me/o/walk/create" className="mobilenav_create">
      <FaHiking size={46} />
    ...
    {isLogged && (
      <>
        ...
        <a href="http://orando.me/o/logout" className="mobilenav_connected" type="submit" onClick={handleLogout}>
