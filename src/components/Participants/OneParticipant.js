...
const OneParticipant = ({ id, nickname, picture }) => (
  <div className="oneParticipant">
    ...
    <p className="one_participant_contact"><a href={`https://orando.me/o/profile/${id}/contact-user`}>Contacter<span className="one_participant_nickname">{nickname}</span></a></p>
  </div>
);
